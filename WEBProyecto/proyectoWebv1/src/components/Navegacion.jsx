...
import { FaUserCircle } from 'react-icons/fa'; // Agrega esta línea

export default function Navegacion({ vistaActual, onCambiarVista, usuarioLogueado, onIrPerfil }) {
  ...
  return (
    <nav className="modern-navbar">
      ...
      <div className="navbar-content">
        ...
        {/* Ícono de perfil fuera del menú */}
        {usuarioLogueado && (
          <button
            className="perfil-icon-btn"
            onClick={onIrPerfil}
            style={{ background: 'none', border: 'none', cursor: 'pointer', marginLeft: '16px' }}
